...
function controlsSlider() {
  // Get all elements
  const sliderWrapperControls = document.getElementById('sliderWrapperControls');
  ...
  // Previous slide
  function prevSlide() {
    currentIndex = (currentIndex - 1 + sliderWrapperImages.length) % sliderWrapperImages.length;
    updateSlider();
  }
